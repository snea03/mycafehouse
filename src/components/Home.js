                ...
                <div className="container">
                    ...
                    <Slider {...settings}>
                        <div className="position-relative ">
                            <img src="assets/images/home.jpeg" className="img-fluid"  />
                        ...
                        <div className="position-relative">
                           ...
                           <div className="hdd"> <h3 className="text2-fluid ">It's time to  <span>Need a break</span></h3>
                            ...
                            <div className="header-btns mt-5">
                                <a href="/menu" className="m-btn1">Menu</a>
                                &nbsp; &nbsp;
                                <a href="/contact" className="b-btn1">Booking</a>
                                </div>
                        </div>
                        <div className="position-relative">
